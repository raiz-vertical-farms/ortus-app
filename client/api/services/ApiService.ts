...
export interface ApiService {
    ...
    deviceSwitch: {
        /** @summary Send a switch command to a device */
        <TMeta extends Record<string, any>, TSignal extends AbortSignal = AbortSignal>(options: ServiceOperationMutationFnOptions<DeviceSwitchBody, DeviceSwitchParameters, TMeta, TSignal>, client?: (schema: DeviceSwitchSchema, options: ServiceOperationMutationFnOptions<DeviceSwitchBody, DeviceSwitchParameters, TMeta, TSignal>) => Promise<RequestFnResponse<DeviceSwitchData, DeviceSwitchError>>): Promise<RequestFnResponse<DeviceSwitchData, DeviceSwitchError>>;
        /** @summary Send a switch command to a device */
        getMutationKey(parameters: DeepReadonly<DeviceSwitchParameters> | void): ServiceOperationMutationKey<DeviceSwitchSchema, DeviceSwitchParameters>;
        /**
         * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
         * Handles loading state, optimistic updates, and error handling.
         *
         ...
         * @example Mutation with predefined parameters, e.g., for updating
         * ```ts
         * const { mutate, isPending } = qraft.apiService.deviceSwitch.useMutation({
         *     path: {
         *         id: id,
         *         switchId: switchId
         *     }
         ...
         * ```
         */
        useMutation<TVariables extends DeviceSwitchBody, TContext = unknown>(parameters: DeepReadonly<DeviceSwitchParameters>, options?: ServiceOperationUseMutationOptions<DeviceSwitchSchema, DeviceSwitchData, DeviceSwitchParameters, TVariables, OperationError<DeviceSwitchError>, TContext>): UseMutationResult<DeviceSwitchData, OperationError<DeviceSwitchError>, TVariables | void, TContext>;
        /**
         * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
         * Handles loading state, optimistic updates, and error handling.
         *
         ...
         * ```
         */
        useMutation<TVariables extends MutationVariables<DeviceSwitchBody, DeviceSwitchParameters>, TContext = unknown>(parameters: void, options?: ServiceOperationUseMutationOptions<DeviceSwitchSchema, DeviceSwitchData, DeviceSwitchParameters, TVariables, OperationError<DeviceSwitchError>, TContext>): UseMutationResult<DeviceSwitchData, OperationError<DeviceSwitchError>, TVariables, TContext>;
        /**
         * Returns the count of currently in-progress mutations.
         *
         * @summary Send a switch command to a device
         ...
         * @example Check how many mutations are currently in progress for the specified service method.
         * ```ts
         * const deviceSwitchTotal = qraft.apiService.deviceSwitch.useIsMutating()
         * ```
         * @example Check how many mutations are currently in progress with the specified parameters.
         * ```ts
         * const deviceSwitchTotal = qraft.apiService.deviceSwitch.useIsMutating({
         ...
         * ```
         */
        useIsMutating<TContext = unknown>(filters?: MutationFiltersByParameters<DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext> | MutationFiltersByMutationKey<DeviceSwitchSchema, DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext>): number;
        /**
         * Provides access to the current state of a mutation, including its status, any resulting data, and associated errors.
         *
         * @summary Send a switch command to a device
         ...
         * @example Get all variables of all running mutations.
         * ```ts
         * const deviceSwitchPendingMutationVariables = qraft.apiService.deviceSwitch.useMutationState({
         *     filters: {
         *         status: "pending"
         *     },
         *     select: mutation => mutation.state.variables
         ...
         * @example Get all data for specific mutations via the `parameters`.
         * ```ts
         * const deviceSwitchMutationData = qraft.apiService.deviceSwitch.useMutationState({
         *     filters: {
         *         parameters: {
         *             path: {
         *                 id: id,
         ...
         * ```
         */
        useMutationState<TContext = unknown, TResult = MutationState<DeviceSwitchData, OperationError<DeviceSwitchError>, MutationVariables<DeviceSwitchBody, DeviceSwitchParameters>, TContext>>(options?: {
            filters?: MutationFiltersByParameters<DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext> | MutationFiltersByMutationKey<DeviceSwitchSchema, DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext>;
            select?: (mutation: Mutation<DeviceSwitchData, OperationError<DeviceSwitchError>, MutationVariables<DeviceSwitchBody, DeviceSwitchParameters>, TContext>) => TResult;
        }): Array<TResult>;
        /** @summary Send a switch command to a device */
        isMutating<TContext>(filters?: MutationFiltersByParameters<DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext> | MutationFiltersByMutationKey<DeviceSwitchSchema, DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext>): number;
        /**
         ...
         * @example Find a mutation with specific parameters
         * ```ts
         * const mutationCache = qraft.apiService.deviceSwitch.getMutationCache();
         * const mutation = mutationCache.find({
         *     parameters: {
         *         path: {
         *             id: id,
         ...
         */
        getMutationCache(): Omit<MutationCache, "find" | "findAll"> & {
            find<TContext = unknown>(filters: MutationFiltersByParameters<DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext> | MutationFiltersByMutationKey<DeviceSwitchSchema, DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext>): Mutation<DeviceSwitchData, DeviceSwitchError, MutationVariables<DeviceSwitchBody, DeviceSwitchParameters>, TContext> | undefined;
            findAll<TContext = unknown>(filters?: MutationFiltersByParameters<DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext> | MutationFiltersByMutationKey<DeviceSwitchSchema, DeviceSwitchBody, DeviceSwitchData, DeviceSwitchParameters, OperationError<DeviceSwitchError>, TContext>): Array<Mutation<DeviceSwitchData, DeviceSwitchError, MutationVariables<DeviceSwitchBody, DeviceSwitchParameters>, TContext>>;
        };
        schema: DeviceSwitchSchema;
        types: {
            parameters: DeviceSwitchParameters;
            data: DeviceSwitchData;
            error: DeviceSwitchError;
            body: DeviceSwitchBody;
        };
    };
    /** @summary Send a light command to a device */
    deviceLight: {
        /** @summary Send a light command to a device */
        <TMeta extends Record<string, any>, TSignal extends AbortSignal = AbortSignal>(options: ServiceOperationMutationFnOptions<DeviceLightBody, DeviceLightParameters, TMeta, TSignal>, client?: (schema: DeviceLightSchema, options: ServiceOperationMutationFnOptions<DeviceLightBody, DeviceLightParameters, TMeta, TSignal>) => Promise<RequestFnResponse<DeviceLightData, DeviceLightError>>): Promise<RequestFnResponse<DeviceLightData, DeviceLightError>>;
        /** @summary Send a light command to a device */
        getMutationKey(parameters: DeepReadonly<DeviceLightParameters> | void): ServiceOperationMutationKey<DeviceLightSchema, DeviceLightParameters>;
        /**
         * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
         * Handles loading state, optimistic updates, and error handling.
         *
         ...
         * @example Mutation with predefined parameters, e.g., for updating
         * ```ts
         * const { mutate, isPending } = qraft.apiService.deviceLight.useMutation({
         *     path: {
         *         id: id,
         *         lightId: lightId
         *     }
         ...
         * ```
         */
        useMutation<TVariables extends DeviceLightBody, TContext = unknown>(parameters: DeepReadonly<DeviceLightParameters>, options?: ServiceOperationUseMutationOptions<DeviceLightSchema, DeviceLightData, DeviceLightParameters, TVariables, OperationError<DeviceLightError>, TContext>): UseMutationResult<DeviceLightData, OperationError<DeviceLightError>, TVariables | void, TContext>;
        /**
         * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
         * Handles loading state, optimistic updates, and error handling.
         *
         ...
         * ```
         */
        useMutation<TVariables extends MutationVariables<DeviceLightBody, DeviceLightParameters>, TContext = unknown>(parameters: void, options?: ServiceOperationUseMutationOptions<DeviceLightSchema, DeviceLightData, DeviceLightParameters, TVariables, OperationError<DeviceLightError>, TContext>): UseMutationResult<DeviceLightData, OperationError<DeviceLightError>, TVariables, TContext>;
        /**
         * Returns the count of currently in-progress mutations.
         *
         * @summary Send a light command to a device
         ...
         * @example Check how many mutations are currently in progress for the specified service method.
         * ```ts
         * const deviceLightTotal = qraft.apiService.deviceLight.useIsMutating()
         * ```
         * @example Check how many mutations are currently in progress with the specified parameters.
         * ```ts
         * const deviceLightTotal = qraft.apiService.deviceLight.useIsMutating({
         ...
         * ```
         */
        useIsMutating<TContext = unknown>(filters?: MutationFiltersByParameters<DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext> | MutationFiltersByMutationKey<DeviceLightSchema, DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext>): number;
        /**
         * Provides access to the current state of a mutation, including its status, any resulting data, and associated errors.
         *
         * @summary Send a light command to a device
         ...
         * @example Get all variables of all running mutations.
         * ```ts
         * const deviceLightPendingMutationVariables = qraft.apiService.deviceLight.useMutationState({
         *     filters: {
         *         status: "pending"
         *     },
         *     select: mutation => mutation.state.variables
         ...
         * @example Get all data for specific mutations via the `parameters`.
         * ```ts
         * const deviceLightMutationData = qraft.apiService.deviceLight.useMutationState({
         *     filters: {
         *         parameters: {
         *             path: {
         *                 id: id,
         ...
         * ```
         */
        useMutationState<TContext = unknown, TResult = MutationState<DeviceLightData, OperationError<DeviceLightError>, MutationVariables<DeviceLightBody, DeviceLightParameters>, TContext>>(options?: {
            filters?: MutationFiltersByParameters<DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext> | MutationFiltersByMutationKey<DeviceLightSchema, DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext>;
            select?: (mutation: Mutation<DeviceLightData, OperationError<DeviceLightError>, MutationVariables<DeviceLightBody, DeviceLightParameters>, TContext>) => TResult;
        }): Array<TResult>;
        /** @summary Send a light command to a device */
        isMutating<TContext>(filters?: MutationFiltersByParameters<DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext> | MutationFiltersByMutationKey<DeviceLightSchema, DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext>): number;
        /**
         * Returns a `MutationCache` object that provides access to mutation cache operations
         * for the specific endpoint.
         *
         ...
         * @example Find a mutation with specific parameters
         * ```ts
         * const mutationCache = qraft.apiService.deviceLight.getMutationCache();
         * const mutation = mutationCache.find({
         *     parameters: {
         *         path: {
         *             id: id,
         ...
         */
        getMutationCache(): Omit<MutationCache, "find" | "findAll"> & {
            find<TContext = unknown>(filters: MutationFiltersByParameters<DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext> | MutationFiltersByMutationKey<DeviceLightSchema, DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext>): Mutation<DeviceLightData, DeviceLightError, MutationVariables<DeviceLightBody, DeviceLightParameters>, TContext> | undefined;
            findAll<TContext = unknown>(filters?: MutationFiltersByParameters<DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext> | MutationFiltersByMutationKey<DeviceLightSchema, DeviceLightBody, DeviceLightData, DeviceLightParameters, OperationError<DeviceLightError>, TContext>): Array<Mutation<DeviceLightData, DeviceLightError, MutationVariables<DeviceLightBody, DeviceLightParameters>, TContext>>;
        };
        schema: DeviceLightSchema;
        types: {
            parameters: DeviceLightParameters;
            data: DeviceLightData;
            error: DeviceLightError;
            body: DeviceLightBody;
        };
    };
    /** @summary Send a numeric command to a device */
    deviceNumber: {
        /** @summary Send a numeric command to a device */
        <TMeta extends Record<string, any>, TSignal extends AbortSignal = AbortSignal>(options: ServiceOperationMutationFnOptions<DeviceNumberBody, DeviceNumberParameters, TMeta, TSignal>, client?: (schema: DeviceNumberSchema, options: ServiceOperationMutationFnOptions<DeviceNumberBody, DeviceNumberParameters, TMeta, TSignal>) => Promise<RequestFnResponse<DeviceNumberData, DeviceNumberError>>): Promise<RequestFnResponse<DeviceNumberData, DeviceNumberError>>;
        /** @summary Send a numeric command to a device */
        getMutationKey(parameters: DeepReadonly<DeviceNumberParameters> | void): ServiceOperationMutationKey<DeviceNumberSchema, DeviceNumberParameters>;
        /**
         * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
         * Handles loading state, optimistic updates, and error handling.
         *
         ...
         * @example Mutation with predefined parameters, e.g., for updating
         * ```ts
         * const { mutate, isPending } = qraft.apiService.deviceNumber.useMutation({
         *     path: {
         *         id: id,
         *         numberId: numberId
         *     }
         ...
         * ```
         */
        useMutation<TVariables extends DeviceNumberBody, TContext = unknown>(parameters: DeepReadonly<DeviceNumberParameters>, options?: ServiceOperationUseMutationOptions<DeviceNumberSchema, DeviceNumberData, DeviceNumberParameters, TVariables, OperationError<DeviceNumberError>, TContext>): UseMutationResult<DeviceNumberData, OperationError<DeviceNumberError>, TVariables | void, TContext>;
        /**
         * Enables performing asynchronous data mutation operations such as POST, PUT, PATCH, or DELETE requests.
         * Handles loading state, optimistic updates, and error handling.
         *
         ...
         * ```
         */
        useMutation<TVariables extends MutationVariables<DeviceNumberBody, DeviceNumberParameters>, TContext = unknown>(parameters: void, options?: ServiceOperationUseMutationOptions<DeviceNumberSchema, DeviceNumberData, DeviceNumberParameters, TVariables, OperationError<DeviceNumberError>, TContext>): UseMutationResult<DeviceNumberData, OperationError<DeviceNumberError>, TVariables, TContext>;
        /**
         * Returns the count of currently in-progress mutations.
         *
         * @summary Send a numeric command to a device
         ...
         * @example Check how many mutations are currently in progress for the specified service method.
         * ```ts
         * const deviceNumberTotal = qraft.apiService.deviceNumber.useIsMutating()
         * ```
         * @example Check how many mutations are currently in progress with the specified parameters.
         * ```ts
         * const deviceNumberTotal = qraft.apiService.deviceNumber.useIsMutating({
         ...
         * ```
         */
        useIsMutating<TContext = unknown>(filters?: MutationFiltersByParameters<DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext> | MutationFiltersByMutationKey<DeviceNumberSchema, DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext>): number;
        /**
         * Provides access to the current state of a mutation, including its status, any resulting data, and associated errors.
         *
         * @summary Send a numeric command to a device
         ...
         * @example Get all variables of all running mutations.
         * ```ts
         * const deviceNumberPendingMutationVariables = qraft.apiService.deviceNumber.useMutationState({
         *     filters: {
         *         status: "pending"
         *     },
         *     select: mutation => mutation.state.variables
         ...
         * @example Get all data for specific mutations via the `parameters`.
         * ```ts
         * const deviceNumberMutationData = qraft.apiService.deviceNumber.useMutationState({
         *     filters: {
         *         parameters: {
         *             path: {
         *                 id: id,
         ...
         * ```
         */
        useMutationState<TContext = unknown, TResult = MutationState<DeviceNumberData, OperationError<DeviceNumberError>, MutationVariables<DeviceNumberBody, DeviceNumberParameters>, TContext>>(options?: {
            filters?: MutationFiltersByParameters<DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext> | MutationFiltersByMutationKey<DeviceNumberSchema, DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext>;
            select?: (mutation: Mutation<DeviceNumberData, OperationError<DeviceNumberError>, MutationVariables<DeviceNumberBody, DeviceNumberParameters>, TContext>) => TResult;
        }): Array<TResult>;
        /** @summary Send a numeric command to a device */
        isMutating<TContext>(filters?: MutationFiltersByParameters<DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext> | MutationFiltersByMutationKey<DeviceNumberSchema, DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext>): number;
        /**
         ...
         * @example Find a mutation with specific parameters
         * ```ts
         * const mutationCache = qraft.apiService.deviceNumber.getMutationCache();
         * const mutation = mutationCache.find({
         *     parameters: {
         *         path: {
         *             id: id,
         ...
         */
        getMutationCache(): Omit<MutationCache, "find" | "findAll"> & {
            find<TContext = unknown>(filters: MutationFiltersByParameters<DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext> | MutationFiltersByMutationKey<DeviceNumberSchema, DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext>): Mutation<DeviceNumberData, DeviceNumberError, MutationVariables<DeviceNumberBody, DeviceNumberParameters>, TContext> | undefined;
            findAll<TContext = unknown>(filters?: MutationFiltersByParameters<DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext> | MutationFiltersByMutationKey<DeviceNumberSchema, DeviceNumberBody, DeviceNumberData, DeviceNumberParameters, OperationError<DeviceNumberError>, TContext>): Array<Mutation<DeviceNumberData, DeviceNumberError, MutationVariables<DeviceNumberBody, DeviceNumberParameters>, TContext>>;
        };
        schema: DeviceNumberSchema;
        types: {
            parameters: DeviceNumberParameters;
            data: DeviceNumberData;
            error: DeviceNumberError;
            body: DeviceNumberBody;
        };
    };
...
export const deviceSwitch = {
    schema: {
        method: "post",
        url: "/api/device/{id}/switch/{switchId}",
        mediaType: ["application/json"]
    }
} as {
    schema: DeviceSwitchSchema;
    [QraftServiceOperationsToken]: ApiService["deviceSwitch"];
};
/** @summary Send a light command to a device */
export const deviceLight = {
    schema: {
        method: "post",
        url: "/api/device/{id}/light/{lightId}",
        mediaType: ["application/json"]
    }
} as {
    schema: DeviceLightSchema;
    [QraftServiceOperationsToken]: ApiService["deviceLight"];
};
/** @summary Send a numeric command to a device */
export const deviceNumber = {
    schema: {
        method: "post",
        url: "/api/device/{id}/number/{numberId}",
        mediaType: ["application/json"]
    }
} as {
    schema: DeviceNumberSchema;
    [QraftServiceOperationsToken]: ApiService["deviceNumber"];
};
/** @summary Retrieve the latest state for a specific device */
...
type DeviceSwitchParameters = paths["/api/device/{id}/switch/{switchId}"]["post"]["parameters"];
type DeviceSwitchData = paths["/api/device/{id}/switch/{switchId}"]["post"]["responses"]["200"]["content"]["application/json"];
type DeviceSwitchError = unknown;
type DeviceSwitchBody = NonNullable<paths["/api/device/{id}/switch/{switchId}"]["post"]["requestBody"]>["content"]["application/json"];
type DeviceLightSchema = {
    method: "post";
    url: "/api/device/{id}/light/{lightId}";
    mediaType: [
        "application/json"
...
type DeviceLightParameters = paths["/api/device/{id}/light/{lightId}"]["post"]["parameters"];
type DeviceLightData = paths["/api/device/{id}/light/{lightId}"]["post"]["responses"]["200"]["content"]["application/json"];
type DeviceLightError = unknown;
type DeviceLightBody = NonNullable<paths["/api/device/{id}/light/{lightId}"]["post"]["requestBody"]>["content"]["application/json"];
type DeviceNumberSchema = {
    method: "post";
    url: "/api/device/{id}/number/{numberId}";
    mediaType: [
        "application/json"
...
type DeviceNumberParameters = paths["/api/device/{id}/number/{numberId}"]["post"]["parameters"];
type DeviceNumberData = paths["/api/device/{id}/number/{numberId}"]["post"]["responses"]["200"]["content"]["application/json"];
type DeviceNumberError = unknown;
type DeviceNumberBody = NonNullable<paths["/api/device/{id}/number/{numberId}"]["post"]["requestBody"]>["content"]["application/json"];
...
type AllDevicesData = paths["/api/device/devices"]["get"]["responses"]["200"]["content"]["application/json"];
